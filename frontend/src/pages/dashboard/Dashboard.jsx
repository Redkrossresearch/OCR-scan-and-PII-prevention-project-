            ...
            <table className="w-full">
              <thead>
                <tr className="border-b border-slate-800">
                  ...
                  <th className="text-left text-gray-400 py-3 px-4 text-sm">Document</th>
              ...
              <tbody>
                {auditLogs.map((log, i) => (
                  <tr key={i} className="border-b border-slate-800/50">
                    ...
                    <td className="text-gray-300 py-3 px-4">{log.document}</td>
                    <td className="text-gray-500 py-3 px-4 text-sm">{log.timestamp}</td>
                  </tr>
                ))}
              </tbody>
            </table>
